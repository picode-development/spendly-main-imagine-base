...
import { BarVarient } from "@/components/bar-variant";
        ...
        <Card className="border-none drop-shadow-sm">
            ...
            <CardContent>
                {data.length === 0 ? (
                    ...
                    <>
                        {chartType === "area" && (
                            <AreaVariant data={data} theme={resolvedTheme as "light" | "dark"} />
                        )}
                        {chartType === "bar" && (
                            <BarVarient data={data} theme={resolvedTheme as "light" | "dark"} />
                        )}
                        {chartType === "line" && (
                            <LineVarient data={data} theme={resolvedTheme as "light" | "dark"} />
                        )}
                    </>
                )}
            </CardContent>
